...
# This function takes a list of processes and a key function as inputs and 
# returns a Gantt chart. The function first creates a deep copy of the processes 
# list and sorts it based on the key function. It then calculates the waiting and 
# turnaround times for each process by iterating through the sorted processes list.

# For each process, it adds the current waiting time to the process's waiting time, 
# sets the turnaround time as the sum of the current waiting time and the process's burst time,
#  and updates the average waiting and turnaround times. The function then calculates the 
# average waiting and turnaround times by dividing the total waiting and turnaround times 
# by the number of processes.

# Finally, the function creates a deep copy of the sorted processes list and sorts 
# it based on the process ID. It then returns a Gantt chart object that contains the 
# original list of processes, the finished list of processes, the average waiting time, 
# and the average turnaround time.

# Overall, this function is a simple scheduling algorithm that schedules processes in the 
# order specified by the key function and calculates the waiting and turnaround times 
# for each process.
